...
### Hot spopt regions were  identified by using approach in which summit's start and end is divided by window size and rounded-off to defined as occupancy (The summit bedfiles are already filtered and produced by nextflow):
